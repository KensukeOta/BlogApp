...
@section('content')
    ...
    <p>by <img src="{{ $post->user->path }}" style="width: 32px; height: 32px; border-radius: 50%;" class="mr-2"><a href="{{ action('UserController@home', $post->user->name) }}" class="text-muted">{{ $post->user->name }}</a></p>
